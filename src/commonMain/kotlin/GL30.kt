...
expect fun glGetProgramParameter(program: GLProgram, type: GLProgramParameterType): Int?
...
expect fun glGetShaderParameter(shader: GLShader, type: GLShaderParameterType): Int?
